                            ...
                            <td className="px-2 py-2 text-center">
                              <div className="flex items-center gap-1 justify-center">
                                ...
                                {isCustomProduct(p.id) && (
                                  <>
                                    <button onClick={() => { setEditingCustomProduct(p); setShowProductForm(true); }} className="w-6 h-6 flex items-center justify-center rounded hover:bg-blue-50 text-blue-400 hover:text-blue-600" title="Editar produto">
