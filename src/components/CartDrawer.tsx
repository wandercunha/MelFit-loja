          ...
          <div className="border-t p-4 space-y-3 bg-gray-50">
            {!showCheckout ? (
              <>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    {(
                      ["pix", "credito_vista", "credito_parcelado", "debito"] as PaymentMethod[]
                    ).map((m) => (
                      <button
                        key={m}
              ...
              <>
                ...
                <a
                  href={customer.name.trim() ? whatsappUrl : "#"}
                  target="_blank"
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1fb855] text-white font-bold py-3 rounded-lg transition-colors text-base"
                >
